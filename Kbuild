...
ccflags-$(CONFIG_NVMEVIRT_SSD) += -DBASE_SSD=SAMSUNG_970PRO -DFLUSH_TARGET_POLICY=FIFO -DFLUSH_TIMING_POLICY=FULL -DFLUSH_AMOUNT_POLICY=BUFFER_QUATER -DMAPPING_SIZE=MAPPING_32KB
