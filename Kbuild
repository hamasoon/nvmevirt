...
ccflags-$(CONFIG_NVMEVIRT_SSD) += -DBASE_SSD=SAMSUNG_970PRO -DFLUSH_TARGET_POLICY=FIFO -DFLUSH_TIMING_POLICY=FULL -DFLUSH_AMOUNT_POLICY=BUFFER_ALL -DMAPPING_SIZE=MAPPING_4KB
