...
ccflags-$(CONFIG_NVMEVIRT_SSD) += -DBASE_SSD=SAMSUNG_970PRO -DFLUSH_POLICY=NAIVE
nvmev-$(CONFIG_NVMEVIRT_SSD) += ssd.o conv_ftl.o pqueue/pqueue.o channel_model.o

ccflags-$(CONFIG_NVMEVIRT_SSD_16KB) += -DBASE_SSD=SAMSUNG_970PRO -DMAPPING_16KB -DFLUSH_POLICY=NAIVE
nvmev-$(CONFIG_NVMEVIRT_SSD_16KB) += ssd.o conv_ftl.o pqueue/pqueue.o channel_model.o

ccflags-$(CONFIG_NVMEVIRT_SSD_32KB) += -DBASE_SSD=SAMSUNG_970PRO -DMAPPING_32KB -DFLUSH_POLICY=NAIVE
